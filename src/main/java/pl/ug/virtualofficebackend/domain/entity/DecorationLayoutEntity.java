...
public class DecorationLayoutEntity {
    ...
    private DecorationEntity decorationByDecorationId;
    ...
    @OneToOne
    @JoinColumn(name = "decoration_id", referencedColumnName = "decoration_id", nullable = false)
    public DecorationEntity getDecorationByDecorationId() {
        return decorationByDecorationId;
    }

    public void setDecorationByDecorationId(DecorationEntity decorationByDecorationId) {
